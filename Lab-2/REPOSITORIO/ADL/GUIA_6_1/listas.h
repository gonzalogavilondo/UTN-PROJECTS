...
**/
nodoSt *inicListaSt();
nodoSt *crearNodoSt(stNotaAlumno);
...
nodoSt *agregarOrdenadoNotaSt(nodoSt *, nodoSt *);
...
int sumarNotasListaSt(nodoSt *);

int sumarNotasListaRecursivo(nodoSt*);
int sumarNotasListaRecursivoTernario(nodoSt*);
void mostrarUnNodo(nodoSt* aux);
void recorrerYmostrar(nodoSt*);
int cuentaAlumnos(nodoSt*);
